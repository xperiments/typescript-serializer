...
///<reference path="build/Serializer.d.ts"/>
...
class BasicTestModelSerializer implements ISerializerHelper
{
	...
	childModel:BasicChildTestModel = null;
	childModelArray:BasicChildTestModel[] = null;
}
...
Serializer.registerClass(()=>{ return BasicChildTestModel },BasicChildTestModelSerializer);
Serializer.registerClass(()=>{ return CustomSerializerModel },CustomSerializerSerializer);
Serializer.registerClass(()=>{ return CustomImageModel },CustomImageModelSerializer);
...
test("Cloning Simple Types [string,number,boolean,string[],number[],boolean[],Object,Object[]",()=>{
	// Arrange
...
test("Cloning with Custom Serializer methods [ Date YYYY/MM/DD ]",()=>{
	// Arrange
